...
const productFormSchema = z.object({
  ...
  price: z.number().min(0, "Puchase price must be positive"),
...
export default function ProductManagement() {
  ...
  const filteredProducts = products.filter(
    (product) =>
      product.Renamedpackage?.description
        .toLowerCase()
  ...
  const handleEdit = (product: ProductType) => {
    ...
    productForm.reset({
      ...
      net_price: Number(product.net_price),
                    ...
                    >
                          ...
                          <FormItem>
                            <FormLabel className="flex items-center justify-between">
                              ...
                              <Button
                                ...
                                variant="ghost"
                                size="sm"
                                onClick={() => setIsAddProductTypeDialogOpen(true)}
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel>Puchase Price</FormLabel>
                              <FormControl>
                                <Input
                                  type="number"
                                  min="0"
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-gray-50">
                  ...
                  <TableHead>Puchase Price</TableHead>
                  ...
                  filteredProducts
                    ...
                    .map((product, index) => (
                      <TableRow key={product.id} className="hover:bg-gray-50">
                        ...
                        <TableCell>
                          {product.Renamedpackage?.description || "N/A"}
                        </TableCell>
                        <TableCell>{product.product_type.name}</TableCell>
                        <TableCell>{formatCurrency(Number(product.price))}</TableCell>
                        <TableCell>{formatCurrency(Number(product.net_price))}</TableCell>
