                ...
                <Dialog open={isAddModalOpen} onOpenChange={setIsAddModalOpen}>
                  ...
                  <DialogContent className="max-w-2xl">
                    ...
                    <CustomerForm
                      ...
                      setIsCompanyEditModalOpen={setIsCompanyEditModalOpen}
                    />
                  </DialogContent>
                </Dialog>
              </div>
...
function CustomerForm({
  ...
  setIsCompanyEditModalOpen: React.Dispatch<React.SetStateAction<boolean>>;
}) {
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          <Label htmlFor="company" className="flex justify-between">
            Company <Button variant={"ghost"} onClick={() => setIsCompanyEditModalOpen(true)}>add new </Button>
          </Label>
          <Select
