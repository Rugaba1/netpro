  ...
  const [packages] = useState([
    {
      id: 1,
      packageType: "4G LTE",
      packageDescription: "This Package Is For Those Big Company",
      creationDate: "2025-02-13 05:22:29",
      updationDate: "2025-03-28 03:00:50",
    },
    {
      id: 2,
      packageType: "BROADBAND",
      packageDescription: "This Package Is For Those Big Company",
      creationDate: "2025-02-13 07:44:34",
      updationDate: "2025-03-28 04:59:22",
    },
    {
      id: 3,
      packageType: "BSME",
      packageDescription: "Broadband for SME",
      creationDate: "2025-04-08 08:27:59",
      updationDate: "0000-00-00 00:00:00",
    },
    {
      id: 4,
      packageType: "HBB Kigali",
      packageDescription: "HBB in Kigali area",
      creationDate: "2025-04-10 03:43:00",
      updationDate: "0000-00-00 00:00:00",
    },
    {
      id: 5,
      packageType: "VPN BB",
      packageDescription: "VPN Broadband",
      creationDate: "2025-06-03 12:29:34",
      updationDate: "0000-00-00 00:00:00",
    },
    {
      id: 6,
      packageType: "YELLOW PACK",
      packageDescription: "YELLOW PACK",
      creationDate: "2025-06-23 04:13:48",
      updationDate: "0000-00-00 00:00:00",
    },
  ])
              ...
              <TableBody>
                {filteredPackages.slice(0, Number.parseInt(showEntries)).map((pkg, index) => (
                  <TableRow key={pkg.id} className="hover:bg-gray-50">
                    ...
                    <TableCell className="font-medium">{pkg.packageType}</TableCell>
                    <TableCell>{pkg.packageDescription}</TableCell>
                    <TableCell>{pkg.creationDate}</TableCell>
                    <TableCell>{pkg.updationDate}</TableCell>
