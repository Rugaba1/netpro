...
// Icons
import { Search, Plus, Package, AlertTriangle, DollarSign, Edit, Trash2, Info, Calendar, Tag, Layers } from "lucide-react"
...
export default function StockManagement() {
  ...
  const handleViewProduct = (stockItem: StockItemWithRelations) => {
            ...
            <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        {formatCurrency(Number(selectedProduct.net_price))}
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        {selectedProduct.package_id ? `Package #${selectedProduct.package_id}` : 'No package'}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Type ID: {selectedProduct.type_id}
                      </p>
                    </div>
                  </div>
              ...
              <div className="pt-4 border-t">
                ...
                <div className="bg-muted/50 rounded-lg p-3 text-sm">
                  <p className="text-muted-foreground">
                    This product is available for sale with a duration of {selectedProduct.duration} days. 
                    The price is set at {formatCurrency(Number(selectedProduct.price))} with a net price of {formatCurrency(Number(selectedProduct.net_price))}.
                  </p>
                </div>
              </div>
              ...
              <div className="flex justify-end gap-2 pt-4">
                ...
                <Button
                  onClick={() => {
                    // Navigate to product edit page or open edit dialog
