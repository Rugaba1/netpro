...
export default function ManageCustomers() {
  ...
  const sampleCustomers: Customer[] = [
    ...
    {
      id: 2,
      customerName: "NSHIMYUMUREMY Boniface",
      billingName: "RIESCO Ltd",
      tin: "122433221",
      phone: "0788606201",
      serviceNumber: "0776345299",
      email: "boniface@riesco.rw",
      address: "Kigali, Rwanda",
      status: "active",
    },
    {
    ...
    },
    {
      ...
      tin: "108364757",
      phone: "0786646456",
      serviceNumber: "0771178460",
      email: "eric@disacco.rw",
      address: "Kigali, Rwanda",
      status: "active",
    },
    {
                  ...
                  {isLoading ? (
                    ...
                    currentEntries.map((customer, index) => (
                      <TableRow key={customer.id} className="hover:bg-gray-50">
                        ...
                        <TableCell className="font-medium border-r border-gray-200">{customer.customerName}</TableCell>
                        <TableCell className="border-r border-gray-200">{customer.billingName}</TableCell>
                        ...
                        <TableCell className="border-r border-gray-200">{customer.serviceNumber}</TableCell>
