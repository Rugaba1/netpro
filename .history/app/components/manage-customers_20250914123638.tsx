...
export default function ManageCustomersAndCompanies() {
  ...
  useEffect(() => {
    Promise.all([getCustomers(), getCompanies()]).finally(() =>
      setIsLoading(false)
    );
  }, []);
  ...
  const handleDeleteCompany = async (companyId: number) => {
    if (
      confirm(
        "Are you sure you want to delete this company? This will also delete all associated customers."
      )
    ) {
      try {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
                ...
                <Dialog open={isAddModalOpen} onOpenChange={setIsAddModalOpen}>
                  ...
                  <DialogContent className="max-w-2xl">
                    ...
                    <CustomerForm
                      ...
                      setIsCompanyAddModalOpen={setIsCompanyAddModalOpen}
                      isCompanyAddModalOpen={isCompanyAddModalOpen}
                    />
                  </DialogContent>
                </Dialog>
              </div>
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow className="bg-gray-50">
                        <TableHead className="w-12 text-center border-r border-gray-200">
                          No
                        </TableHead>
                    ...
                    <TableBody>
                      {isLoading ? (
                        ...
                        (currentEntries as Customer[]).map(
                          (customer, index) => (
                            <TableRow
                              key={customer.id}
          ...
          <TabsContent value="companies">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200">
              <div className="px-6 py-4 border-b border-gray-200 flex justify-between">
                ...
                <Dialog
                  open={isCompanyAddModalOpen}
                  onOpenChange={setIsCompanyAddModalOpen}
                >
                  <DialogTrigger asChild>
                    <Button>
      ...
      <Dialog
        open={isCompanyEditModalOpen}
        onOpenChange={setIsCompanyEditModalOpen}
      >
        <DialogContent className="max-w-2xl">
          <DialogHeader>
...
function CustomerForm({
  ...
  companies,
  onSubmit,
  setIsCompanyAddModalOpen,
  isCompanyAddModalOpen
}: {
  customer?: Customer;
  companies: Company[];
  onSubmit: (data: Partial<Customer>) => void;
  setIsCompanyAddModalOpen: React.Dispatch<React.SetStateAction<boolean>>;
  isCompanyAddModalOpen: boolean;
}) {
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <Input
            ...
            onChange={(e) =>
              setFormData({ ...formData, service_number: e.target.value })
            }
            required
          />
        </div>
        <div>
          ...
          <Select
            ...
            onValueChange={(value) =>
              setFormData({
                ...formData,
                company_id: value ? parseInt(value) : "",
              })
            }
          >
            <SelectTrigger>
          ...
          {typeof window !== "undefined" && (
            ...
            >
              <DialogContent className="max-w-2xl">
                ...
                <CompanyForm
                  onSubmit={(data) => {
                    // You may want to call an API here to add the company and update the companies list in parent
                    setIsCompanyAddModalOpen(false);
                  }}
                />
              </DialogContent>
