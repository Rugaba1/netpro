...
import { Eye, Edit, RefreshCw, Trash2, FileText, Plus, Trash } from "lucide-react"
...
export default function ManageInvoice() {
  const [invoices, setInvoices] = useState([
    {
      ...
      productType: "120Mbps, Galaxy S21, B315-22s",
      paymentMethod: "Cash",
      amountToPay: "126000",
      paidAmount: "126000",
      remainedAmount: "0",
    ...
    },
    {
      ...
      productType: "Prepaid Unlimited, MKZ-Broadband",
      paymentMethod: "Mobile Money",
      amountToPay: "90000",
      paidAmount: "40000",
      remainedAmount: "50000",
      startedDate: "2025-03-18",
      expiredDate: "2025-04-18",
      status: "partial",
    },
    {
      id: 3,
      ...
      productType: "Postpaid Unlimited",
      paymentMethod: "",
      amountToPay: "20000",
      paidAmount: "0",
      remainedAmount: "20000",
      startedDate: "2025-03-20",
      expiredDate: "2025-04-20",
      status: "unpaid",
    },
  ])

  const [customers] = useState([
    { id: 1, name: "RUGABA Innocent Gilbert", billingName: "RCD CORPORATION Ltd" },
    { id: 2, name: "NSHIMYUMUREMYI Boniface", billingName: "RIESCO Ltd" },
    { id: 3, name: "TUYISHIME Alain Serge", billingName: "ERR CORP" },
    { id: 4, name: "Muhorane Eric", billingName: "DISACCO" },
    { id: 5, name: "Hakizimana Yves", billingName: "Hakizimana Yves" },
    { id: 6, name: "John Doe", billingName: "RCD CORPORATION Ltd" },
    { id: 7, name: "Jane Smith", billingName: "RIESCO Ltd" },
    { id: 8, name: "Bob Wilson", billingName: "ERR CORP" },
    { id: 9, name: "Alice Brown", billingName: "DISACCO" },
    { id: 10, name: "Charlie Davis", billingName: "RCD CORPORATION Ltd" },
  ])

  const [packages] = useState([
    // Internet Service Packages
    { id: 1, name: "4G LTE", type: "service" },
    { id: 2, name: "BROADBAND", type: "service" },
    { id: 3, name: "BSME", type: "service" },
    { id: 4, name: "HBB Kigali", type: "service" },
    { id: 5, name: "VPN BB", type: "service" },
    { id: 6, name: "YELLOW PACK", type: "service" },

    // Hardware/Device Packages
    { id: 7, name: "MOBILE DEVICES", type: "hardware" },
    { id: 8, name: "NETWORK EQUIPMENT", type: "hardware" },
    { id: 9, name: "ACCESSORIES", type: "hardware" },
  ])

  const [products] = useState([
    // Internet Service Products
    { id: 1, name: "Prepaid Unlimited", packageId: 1, price: 18000, type: "service" },
    { id: 2, name: "Postpaid Unlimited", packageId: 1, price: 20000, type: "service" },
    { id: 3, name: "MKZ-Broadband", packageId: 2, price: 40000, type: "service" },
    { id: 4, name: "Prepaid", packageId: 3, price: 50000, type: "service" },
    { id: 5, name: "Prepaid", packageId: 4, price: 30000, type: "service" },
    { id: 6, name: "5Mbps", packageId: 5, price: 360000, type: "service" },
    { id: 7, name: "Postpaid", packageId: 6, price: 40000, type: "service" },

    // Hardware Products
    { id: 8, name: "Smartphones", packageId: 7, price: 0, type: "hardware" },
    { id: 9, name: "Tablets", packageId: 7, price: 0, type: "hardware" },
    { id: 10, name: "Routers", packageId: 8, price: 0, type: "hardware" },
    { id: 11, name: "Modems", packageId: 8, price: 0, type: "hardware" },
    { id: 12, name: "Cables & Adapters", packageId: 9, price: 0, type: "hardware" },
  ])

  const [items] = useState([
    // Internet Service Items (with duration)
    { id: 1, name: "20Mbps", productId: 1, price: 18000, duration: "30 days", type: "service" },
    { id: 2, name: "20Mbps", productId: 2, price: 20000, duration: "30 days", type: "service" },
    { id: 3, name: "20Mbps", productId: 3, price: 40000, duration: "30 days", type: "service" },
    { id: 4, name: "20Mbps", productId: 4, price: 50000, duration: "5 days", type: "service" },
    { id: 5, name: "50Mbps", productId: 5, price: 30000, duration: "30 days", type: "service" },
    { id: 6, name: "5Mbps", productId: 6, price: 360000, duration: "30 days", type: "service" },
    { id: 7, name: "Up to 10Mbps", productId: 7, price: 40000, duration: "30 days", type: "service" },
    { id: 8, name: "120Mbps", productId: 3, price: 126000, duration: "30 days", type: "service" },

    // Hardware Items (no duration - one-time purchase)
    { id: 9, name: "Galaxy S21", productId: 8, price: 850000, duration: "lifetime", type: "hardware" },
    { id: 10, name: "Galaxy S22", productId: 8, price: 950000, duration: "lifetime", type: "hardware" },
    { id: 11, name: "iPhone 13", productId: 8, price: 1200000, duration: "lifetime", type: "hardware" },
    { id: 12, name: "iPad Air", productId: 9, price: 800000, duration: "lifetime", type: "hardware" },
    { id: 13, name: "Samsung Tab", productId: 9, price: 600000, duration: "lifetime", type: "hardware" },
    { id: 14, name: "B315-22s Router", productId: 10, price: 85000, duration: "lifetime", type: "hardware" },
    { id: 15, name: "B525 Router", productId: 10, price: 120000, duration: "lifetime", type: "hardware" },
    { id: 16, name: "E8372 Modem", productId: 11, price: 45000, duration: "lifetime", type: "hardware" },
    { id: 17, name: "USB-C Cable", productId: 12, price: 5000, duration: "lifetime", type: "hardware" },
    { id: 18, name: "Power Adapter", productId: 12, price: 15000, duration: "lifetime", type: "hardware" },
  ])
  ...
  const getFilteredProducts = () => {
    ...
    return products.filter((product) => product.packageId === Number.parseInt(createForm.package))
  }

  // Get items filtered by selected product
  const getFilteredItems = () => {
    if (!createForm.product) return []
    return items.filter((item) => item.productId === Number.parseInt(createForm.product))
  }
  ...
  const handleCompanySelect = (companyName) => {
    const companyCustomersList = customers.filter((c) => c.billingName === companyName)
  ...
  const handleAddConsolidatedItem = () => {
    ...
    const selectedCustomer = customers.find((c) => c.id === Number.parseInt(createForm.selectedCustomer))
  ...
  const handleViewInvoice = (invoice) => {
    ...
    if (invoice.id === 58) {
      ...
      const isConsolidated = invoice.isConsolidated || invoice.customerName.includes(",")
  ...
  const handleCreateInvoice = () => {
    if (createForm.isConsolidated) {
      ...
      if (!createForm.customerName || !createForm.billingName || createForm.invoiceItems.length === 0) {
    ...
    const serviceItems = createForm.invoiceItems.filter((item) => item.type === "service")
    ...
    const totalAmount = createForm.invoiceItems.reduce((sum, item) => sum + item.amountToPay, 0)
    const totalPaid = createForm.invoiceItems.reduce((sum, item) => sum + item.paidAmount, 0)
    ...
    if (createForm.isConsolidated) {
      ...
      const uniqueCustomers = [...new Set(createForm.invoiceItems.map((item) => item.customerName))]
      customerName = uniqueCustomers.join(", ")
      productType = createForm.invoiceItems.map((item) => `${item.customerName}: ${item.name}`).join(", ")
    } else {
      // For individual invoices, use the selected customer
      customerName = customers.find((c) => c.id === Number.parseInt(createForm.customerName))?.name || ""
  ...
  const handleFinalizeInvoice = () => {
    ...
    const finalInvoice = {
      ...
      remainedAmount: (
        Number.parseFloat(pendingInvoice.amountToPay) - Number.parseFloat(paymentForm.paidAmount)
      ).toString(),
    }
    ...
    finalInvoice.status = paidAmount === 0 ? "unpaid" : paidAmount >= totalAmount ? "paid" : "partial"
  ...
  const handleItemChange = (itemId) => {
    const selectedItem = items.find((item) => item.id === Number.parseInt(itemId))
    setCreateForm((prev) => ({
      ...prev,
      item: itemId,
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-semibold text-gray-900">Manage Invoice</h1>
          <nav className="text-sm text-gray-500 mt-1">
            <span>Home</span> / <span>Invoice</span> / <span>Manage Invoice</span>
          </nav>
        </div>
              ...
              <TableBody>
                {filteredInvoices.map((invoice, index) => (
                  <TableRow key={invoice.id}>
                    ...
                    <TableCell className="min-w-[150px]">{invoice.customerName}</TableCell>
                    <TableCell className="min-w-[150px]">{invoice.billingName}</TableCell>
                    <TableCell className="min-w-[200px]">{invoice.productType}</TableCell>
                    ...
                    <TableCell>
                      <div className="flex space-x-1">
                        ...
                        <Button size="sm" className="bg-cyan-500 hover:bg-cyan-600 p-1" title="Edit Invoice">
                          <Edit className="h-3 w-3" />
                        </Button>
                        <Button size="sm" className="bg-green-500 hover:bg-green-600 p-1" title="Renew Invoice">
                          <RefreshCw className="h-3 w-3" />
                        </Button>
                        <Button size="sm" variant="destructive" className="p-1" title="Delete Invoice">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4 p-4 border rounded">
              <label className="flex items-center space-x-2">
                <input
                  ...
                  onChange={() =>
                    setCreateForm((prev) => ({ ...prev, isConsolidated: false, billingName: "", customerName: "" }))
                  }
                />
              ...
              <label className="flex items-center space-x-2">
                <input
                  ...
                  name="invoiceType"
                  checked={createForm.isConsolidated}
                  onChange={() => setCreateForm((prev) => ({ ...prev, isConsolidated: true, customerName: "" }))}
                />
            ...
            {!createForm.isConsolidated && (
              <>
                <div>
                  ...
                  <Select value={createForm.customerName} onValueChange={handleCustomerChange}>
                    <SelectTrigger>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setCreateForm((prev) => ({ ...prev, billingName: e.target.value }))}
                  />
                </div>
              </>
            )}
            ...
            {createForm.isConsolidated && (
              <>
                ...
                {selectedCompany && (
                  <div>
                    <Label htmlFor="selectedCustomer">Select Customer from {selectedCompany}</Label>
                    <Select
                      value={createForm.selectedCustomer}
                      onValueChange={(value) => setCreateForm((prev) => ({ ...prev, selectedCustomer: value }))}
                    >
                      <SelectTrigger>
                        <SelectValue placeholder="Select Customer" />
                      </SelectTrigger>
            ...
            <div>
              ...
              <Select value={createForm.package} onValueChange={handlePackageChange}>
                <SelectTrigger>
            ...
            <div>
              ...
              <Select value={createForm.product} onValueChange={handleProductChange} disabled={!createForm.package}>
                <SelectTrigger>
            ...
            <div>
              ...
              <Select value={createForm.item} onValueChange={handleItemChange} disabled={!createForm.product}>
                <SelectTrigger>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => setCreateForm((prev) => ({ ...prev, pricing: e.target.value }))}
                readOnly
            ...
            <Button
              onClick={createForm.isConsolidated ? handleAddConsolidatedItem : handleAddItem}
            ...
            {createForm.invoiceItems.length > 0 && (
              <div>
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      {createForm.isConsolidated && <TableHead>Customer</TableHead>}
                  ...
                  <TableBody>
                    {createForm.invoiceItems.map((item) => (
                      <TableRow key={item.id}>
                        ...
                        <TableCell>{item.amountToPay.toLocaleString()}</TableCell>
                        <TableCell>{item.paidAmount.toLocaleString()}</TableCell>
                        <TableCell>
                          <Badge variant={item.type === "service" ? "default" : "secondary"}>{item.duration}</Badge>
                        </TableCell>
                        <TableCell>
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <p>
                        ...
                        {createForm.invoiceItems.reduce((sum, item) => sum + item.amountToPay, 0).toLocaleString()} RWF
                      </p>
                      <p>
                        <strong>Total Paid:</strong>{" "}
                        {createForm.invoiceItems.reduce((sum, item) => sum + item.paidAmount, 0).toLocaleString()} RWF
                      </p>
                    </div>
                    <div>
                      <p>
                        <strong>Calculated Expiry Date:</strong> {(() => {
                          const serviceItems = createForm.invoiceItems.filter((item) => item.type === "service")
                          if (serviceItems.length === 0) return "No service items (Hardware only)"
      ...
      <Dialog open={isPaymentDialogOpen} onOpenChange={setIsPaymentDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Select payment method and confirm payment amount</DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div>
            ...
            {pendingInvoice && (
              <div className="bg-gray-50 p-3 rounded">
                ...
                <p>
                  ...
                  {(
                    Number.parseFloat(pendingInvoice.amountToPay) - Number.parseFloat(paymentForm.paidAmount || "0")
                  ).toFixed(2)}
                </p>
                <p>
                  <strong>Service Period:</strong> {pendingInvoice.startedDate} to {pendingInvoice.expiredDate}
                </p>
              </div>
            )}
          </div>
          <DialogFooter>
            ...
            <Button onClick={handleFinalizeInvoice} className="bg-blue-600 hover:bg-blue-700">
              Finalize Invoice
            </Button>
          </DialogFooter>
        </DialogContent>
      ...
      <Dialog open={isViewDialogOpen} onOpenChange={setIsViewDialogOpen}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>Professional NETPRO invoice format</DialogDescription>
          </DialogHeader>
